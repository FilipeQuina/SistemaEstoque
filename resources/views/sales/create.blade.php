    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group ">
                ...
                {{ csrf_field() }}
                    <input type="hidden" id="listaItens">
                ...
                <div class=row>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="price" id="price" class="form-control" value={{$products->price}} readonly>
                    </div>
                </div>
                ...
                <button class="btn btn-success "> Fechar venda </button>
                </form>
